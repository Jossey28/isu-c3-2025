...
public class PropertiesLauncher extends Launcher {
   ...
   private void loadResource(InputStream resource) throws Exception {
      ...
      if ("true".equals(this.getProperty("loader.system"))) {
         ...
         for (Object keyx : Collections.list(this.properties.propertyNames())) {
            String value = this.properties.getProperty((String)keyx);
            System.setProperty((String)keyx, value);
         }
      }
   }
   ...
   private String getProperty(String propertyKey, String manifestKey, String defaultValue) throws Exception {
      ...
      if (property != null) {
         ...
         Manifest manifestx = this.createArchive().getManifest();
         if (manifestx != null) {
            String value = manifestx.getMainAttributes().getValue(manifestKey);
            if (value != null) {
